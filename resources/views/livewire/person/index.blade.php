            ...
            <section aria-labelledby="products-heading" class="pt-6 pb-24">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                            ...
                            <div class="pt-6" id="filter-section-0">
                                <div class="space-y-4">
                                    <div class="flex items-center relative">
                                        <input name="search" type="text" class="h-10 w-full border-gray-300 rounded text-indigo-600 focus:ring-indigo-500 text-sm pr-8">
                                        <x-heroicon-o-trash class="w-5 text-gray-500 absolute right-2 cursor-pointer" />
                                    </div>
                    ...
                    <div class="lg:col-span-3">
                        ...
                        {{$loop->iteration}}. {{$person->first_name}} {{$person->last_name}}</br>
                        @endforeach
                    </div>
                </div>
            </section>
